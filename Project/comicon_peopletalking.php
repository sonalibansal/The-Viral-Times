...
<div class="row">
<div class="col-md-8">
    <strong><p> Select the graphss you want to view from the adjacent dropdown menu.</p></strong>
</div>
<div class="col-md-4">
<div class="dropdown ">
    ...
    <li><a href="comicon_checkin.php">Checkins</a></li>
    <li class="active"><a href="comicon_peopletalking.php">People Talking</a></li>
...
<div class="container">
            ...
            <?php include("php/comicon_peopletalking.php"); ?>
