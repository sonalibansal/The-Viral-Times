...
<div class="dropdown ">
   ...
   <li ><a href="jaipur.php">Fan count</a></li>
    ...
    <li class="active"><a href="j1.php">Number of likes on posts</a></li>
    <li><a href="j3.php">Number of Comments on posts</a></li>
    </ul>
</div>
</div>        
</div>
...
$queryData = mysql_query("
  ...
  FROM (
    SELECT
      ...
      b.like_count
     AS page2
    FROM rialike_474 AS a
    LEFT JOIN rialike_618 AS b ON (a.year = b.year)
    UNION
    SELECT
      b.year,
      a.like_count AS page1,
    ...
    FROM rialike_474 AS a
    RIGHT JOIN rialike_618 AS b ON (a.year = b.year)
  ) AS x
  ORDER BY year ASC
");
...
<head>
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Jaipur Literature Festival Pages Yearly Popularity Comparison on Basis of Number Of likes on Posts',
        width: 800,
        height: 600,
        hAxis: {
          title: "Year"
