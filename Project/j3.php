...
<head>
    ...
    <!-- Custom CSS -->
    <link href="css/jaipur.css" rel="stylesheet">
...
<br><br>
    ...
    <header class="header-image" style="background-image:"social_media.jpg" ; background-size: cover; background-position: center; height: 200px">
        <div class="headline">
            <div class="container">
                <h2>Jaipur Literature Festival</h2>
...
<li "><a href="jaipur.php">Fan count</a></li>
    <li><a href="j5.php">Checkins</a></li>
    <li><a href="j4.php">People Talking</a></li>
    <li role="separator" class="divider"></li>
    <li class="dropdown-header">Cumulative (Year wise)</li>
    <li><a href="j2.php">Number of posts on pages</a></li>
    <li><a href="j1.php">Number of likes on posts</a></li>
    <li class="active><a href="j3.php">Number of Comments on posts</a></li>
    </ul>
</div>
</div>        
</div>
...
$queryData = mysql_query("
  ...
  FROM (
    SELECT
      ...
      b.comment_count
     AS page2
    FROM riacomment_474 AS a
    LEFT JOIN riacomment_618 AS b ON (a.year = b.year)
    UNION
    SELECT
      b.year,
      a.comment_count AS page1,
    ...
    FROM riacomment_474 AS a
    RIGHT JOIN riacomment_618 AS b ON (a.year = b.year)
  ) AS x
  ORDER BY year ASC
");
...
<head>
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Jaipur Literature Festival Pages Yearly Popularity Comparison on Basis of Number Of Comments',
        width: 800,
        height: 600,
        hAxis: {
          title: "Year"
