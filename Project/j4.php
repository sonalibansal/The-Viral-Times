...
<li ><a href="jaipur.php">Fan count</a></li>
    ...
    <li class="active"><a href="j4.php">People Talking</a></li>
...
$sth = mysql_query("SELECT * FROM ria_people");
...
$table['cols'] = array(
    ...
    array('label' => 'People_talking', 'type' => 'number')
...
while($r = mysql_fetch_assoc($sth)) {
    ...
    $temp[] = array('v' => (int) $r['people_talk']); 
    $rows[] = array('c' => $temp);
}
...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'Jaipur Literature Festival Pages Popularity on Basis Of People talking',
          is3D: 'true',
          width: 800,
          height: 600
        };
