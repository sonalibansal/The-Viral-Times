...
<li ><a href="jaipur.php">Fan count</a></li>
    <li class="active"><a href="j5.php">Checkins</a></li>
...
$sth = mysql_query("SELECT * FROM ria_checkin");
...
while($r = mysql_fetch_assoc($sth)) {
    ...
    $temp[] = array('v' => (int) $r['people_checkin']); 
    $rows[] = array('c' => $temp);
}
...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'Jaipur Literature Festival Pages Popularity on Basis of Checkins',
          is3D: 'true',
          width: 800,
          height: 600
        };
