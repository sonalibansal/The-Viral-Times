...
<div class="dropdown ">
    ...
    <li class="active"><a href="jaipur.php">Fan count</a></li>
...
$sth = mysql_query("SELECT * FROM ria_fancount");
...
?>
  ...
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'Jaipur Literature Festival Pages Popularity on basis of Fan Count',
          is3D: 'true',
          width: 800,
          height: 600
        };
