...
<li ><a href="marathon.php">Fan count</a></li>
    ...
    <li class="active"><a href="m1.php">Number of Comments on posts</a></li>    </ul>
</div>
</div>        
</div>
</div>
...
$queryData = mysql_query("
  ...
  FROM (
    SELECT
      ...
      b.comment_count
     AS page2
    FROM page1_comments AS a
    LEFT JOIN page2_comments AS b ON (a.year = b.year)
    UNION
    SELECT
      b.year,
      a.comment_count AS page1,
    ...
    FROM page1_comments AS a
    RIGHT JOIN page2_comments AS b ON (a.year = b.year)
  ) AS x
  ORDER BY year ASC
");
...
<head>
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Delhi Half Marathon Pages Yearly Popularity Comparison on the basis of Number of Comments',
        width: 800,
        height: 600,
        hAxis: {
          title: "Year"
