...
<li ><a href="marathon.php">Fan count</a></li>
    <li class="active"><a href="m4.php">Checkins</a></li>
...
$sth = mysql_query("SELECT * FROM marathon_checked1");
...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'Delhi Half Marathon Pages Popularity on the basis of Number of Checkins',
          is3D: 'true',
          width: 800,
          height: 600
        };
