...
<li ><a href="marathon.php">Fan count</a></li>
    ...
    <li class="active"><a href="m5.php">People Talking</a></li>
...
$sth = mysql_query("SELECT * FROM marathon_people1");
...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'Delhi Half Marathon Pages Popularity on Basis of Fan People talking',
          is3D: 'true',
          width: 800,
          height: 600
        };
