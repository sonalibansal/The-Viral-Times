...
<li ><a href="raahgiri.php">Fan count</a></li>
    <li class="active"><a href="r1.php">Checkins</a></li>
...
$sth = mysql_query("SELECT * FROM raahgiri_checked");
...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'Raahgiri CP Pages Popularity on the basis of Number of Checkins',
          is3D: 'true',
          width: 800,
          height: 600
        };
