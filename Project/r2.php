...
<li ><a href="raahgiri.php">Fan count</a></li>
    ...
    <li class="active"><a href="r2.php">Number of posts on pages</a></li>
...
$queryData = mysql_query("
  ...
  FROM (
    SELECT
      ...
      b.post_count
     AS page2
    FROM miturahgiripost_1575 AS a
    LEFT JOIN miturahgiripost_60166 AS b ON (a.year = b.year)
    UNION
    SELECT
      b.year,
      a.post_count AS page1,
    ...
    FROM miturahgiripost_1575 AS a
    RIGHT JOIN miturahgiripost_60166 AS b ON (a.year = b.year)
  ) AS x
  ORDER BY year ASC
");
...
<head>
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Raahgiri CP Pages Popularity on the basis of Number of post_count Yearly',
        width: 800,
        height: 600,
        hAxis: {
          title: "Year"
