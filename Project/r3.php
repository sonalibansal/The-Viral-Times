...
<li ><a href="raahgiri.php">Fan count</a></li>
    ...
    <li class="active"><a href="r3.php">Number of likes on posts</a></li>
    <li><a href="r5.php">Number of Comments on posts</a></li></ul>
</div>
</div>        
</div>
</div>
...
$queryData = mysql_query("
  ...
  FROM (
    SELECT
      ...
      b.like_count
     AS page2
    FROM miturahgirilike_1575 AS a
    LEFT JOIN   miturahgirilike_60166 AS b ON (a.year = b.year)
    UNION
    SELECT
      b.year,
      a.like_count AS page1,
    ...
    FROM miturahgirilike_1575 AS a
    RIGHT JOIN  miturahgirilike_60166 AS b ON (a.year = b.year)
  ) AS x
  ORDER BY year ASC
");
...
<head>
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Raahgiri CP Pages Yearly Popularity Comparison on the basis of Number of Likes on Posts ',
        width: 800,
        height: 600,
        hAxis: {
          title: "Year"
