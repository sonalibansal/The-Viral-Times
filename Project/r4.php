...
<li ><a href="raahgiri.php">Fan count</a></li>
    ...
    <li class="active"><a href="r4.php">People Talking</a></li>
...
$sth = mysql_query("SELECT * FROM miturahgiri_people");
...
while($r = mysql_fetch_assoc($sth)) {
    ...
    $temp[] = array('v' => (int) $r['people_talking']); 
    $rows[] = array('c' => $temp);
}
...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'Raahgiri Pages Popularity on Basis Of People talking',
          is3D: 'true',
          width: 800,
          height: 600
        };
