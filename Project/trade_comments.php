...
<div class="row">
<div class="col-md-8">
    <strong><p> Select the graphs you want to view from the adjacent dropdown menu.</p></strong>
</div>
<div class="col-md-4">
<div class="dropdown ">
    ...
    <li><a href="trade_peopletalking.php">People Talking</a></li>
    ...
    <li  class="active"><a href="trade_comments.php">Number of Comments on posts</a></li>
    </ul>
</div>
</div>        
</div>
...
<div class="container">
            ...
            <?php include("php/tradefair_noofcomments.php"); ?>
