...
<div class="dropdown ">
   ...
   <li ><a href="youth.php">Fan count</a></li>
    ...
    <li class="active"><a href="y2.php">Number of likes on posts</a></li>
...
$queryData = mysql_query("
  ...
  FROM (
    SELECT
      ...
      b.like_count
     AS page2
    FROM mituyouthlike_134479 AS a
    LEFT JOIN   mituyouthlike_53138 AS b ON (a.year = b.year)
    UNION
    SELECT
      b.year,
      a.like_count AS page1,
    ...
    FROM mituyouthlike_134479 AS a
    RIGHT JOIN  mituyouthlike_53138 AS b ON (a.year = b.year)
  ) AS x
  ORDER BY year ASC
");
...
<head>
    ...
    function drawChart() {
      ...
      var options = {
        title: 'National Youth Festival Pages Yearly Popularity Comparison on the basis of Number of Likes on Posts ',
        width: 800,
        height: 600,
        hAxis: {
          title: "Year"
