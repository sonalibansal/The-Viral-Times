...
<div class="dropdown ">
   ...
   <li ><a href="youth.php">Fan count</a></li>
    ...
    <li class="active"><a href="y4.php">People Talking</a></li>
...
$sth = mysql_query("SELECT * FROM mitu_youthpeople");
...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'National Youth Festival Pages Popularity on Basis of Fan People talking',
          is3D: 'true',
          width: 800,
          height: 600
        };
