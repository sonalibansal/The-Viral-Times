...
<div class="dropdown ">
    ...
    <li class="active"><a href="yoga_peopletalking.php">People Talking</a></li>
    ...
    <li><a href="yoga_comments.php">Number of Comments on posts</a></li>
    </ul>
</div>
</div>        
</div>
...
<div class="container">
            ...
            <?php include("php/yoga_peopletalking.php"); ?>
