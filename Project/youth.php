...
<div class="dropdown ">
    ...
    <li class="active"><a href="youth.php">Fan count</a></li>
...
$sth = mysql_query("SELECT * FROM mitu_youthfanpost");
...
<html>
  <head>
    ...
    function drawChart() {
      ...
      var options = {
           title: 'National Youth Festival Popularity on Basis of Fan Count',
          is3D: 'true',
          width: 800,
          height: 600
        };
